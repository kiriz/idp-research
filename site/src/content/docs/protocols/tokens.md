...
description: "Kerberos tickets, SAML assertions, JWT, PASETO, and session management across 30 years of identity."
sidebar:
  order: 6
---
...
![Token Format Evolution and Lifecycle](/idp-research/diagrams/10-token-lifecycle.svg)
