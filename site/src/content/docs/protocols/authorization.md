...
description: "XACML, OAuth scopes, OPA/Rego, Cedar — the evolution of policy-based access control from 2003 to today."
sidebar:
  order: 4
---
...
![XACML Policy Evaluation Flow](/idp-research/diagrams/09-xacml-evaluation.svg)
