...
description: "Identity governance and administration: OSGi-based provisioning engine, workflow integration, connector framework. Enterprise IGA context."
sidebar:
  order: 4
---
...
![OpenIDM Provisioning Architecture](/idp-research/diagrams/03-openidm-provisioning.svg)
