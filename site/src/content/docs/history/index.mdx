---
title: 20-Year History of Open-Source IAM
description: "From Sun's OpenSSO (2005) through ForgeRock's commercial era to today's two active forks — the complete narrative, with interactive commit velocity chart showing the defining closure event."
sidebar:
  order: 1
---

import CommitVelocityChart from '../../../components/CommitVelocityChart.astro';
import ProtocolTimeline from '../../../components/ProtocolTimeline.astro';
...
![Historical Timeline](/idp-research/diagrams/04-historical-timeline.svg)
...
![Fork Divergence: ForgeRock CE vs OIP vs Wren Security](/idp-research/diagrams/06-fork-divergence.svg)
...
**Keycloak**, a Red Hat-sponsored open-source IAM platform, has emerged as the dominant community alternative. Written from scratch in Java (using WildFly and Quarkus), it supports OIDC, SAML 2.0, OAuth 2.0, and LDAP user federation. Crucially, it's under **active development with a vibrant community**—~26,000 GitHub stars, bi-monthly releases, and official Red Hat support via Red Hat SSO.
...
**Sources:** Primary git analysis of 7 OIP repositories — [github.com/kiriz/idp-research](https://github.com/kiriz/idp-research)

---

## Identity Standards Evolution
