...
description: "8 comparison matrices across the IAM platform landscape — protocol support, deployment model, developer experience, security posture, and migration complexity."
sidebar:
  order: 1
---
...
![IAM Decision Framework](/idp-research/diagrams/14-iam-decision-tree.svg)
...
![SPIFFE/SPIRE Workload Identity Flow](/idp-research/diagrams/12-spiffe-spire.svg)
